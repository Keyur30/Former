        ...
        {cards.map((card, index) => {
          return (
            ...
            >
              ...
              <div className='w-full h-[300px] overflow-y-auto rounded-xl border-2 hide-scroll'>
                <Preview
              ...
              <div className='absolute bottom-2 text-black w-full p-4 flex justify-between items-center'>
                ...
                <div
                  className='w-12 h-12 text-white grid place-content-center rounded-full bg-black cursor-pointer'
